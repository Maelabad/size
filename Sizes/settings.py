"""
Django settings for Sizes project.
...
ROOT_URLCONF = 'Sizes.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,"Sizes/templates"), os.path.join(BASE_DIR,"Sizes/static/html"),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Sizes.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "Sizes/static/"),
]
